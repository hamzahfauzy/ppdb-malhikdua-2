...
<div class="form-group" id="fg-spf">
    <label for="">Spesifikasi</label>

    <div class="form-check" id="fc-bi">
    ...
    <div class="form-check" id="fc-otkp">
    ...
    <div class="form-check" id="fc-dkv">
    ...
    <div class="form-check" id="fc-tkj">
    ...
    <div class="form-check" id="fc-perikanan">
    ...
    <div class="form-check" id="fc-pengelasan">
...
<div class="form-group" id="extra-peminatan">
    <label for="">Extra Peminatan</label>

    <div class="form-check">
        <input class="form-check-input" type="radio" name="rencana[extra_peminatan]" id="kitab-turats" value="Kitab Turats">
        <label class="form-check-label" for="kitab-turats">
            Kitab Turats
        </label>
    </div>
    <div class="form-check">
        <input class="form-check-input" type="radio" name="rencana[extra_peminatan]" id="tahfidz" value="Tahfidz">
        <label class="form-check-label" for="tahfidz">
            Tahfidz
        </label>
    </div>
</div>