        ...
        <div class="card">
            <div class="card-body">
                ...
                @else
                    ...
                    @if($formulir->status == NULL || $formulir->status == "Ditolak" || $formulir->status == 'draft' || $formulir->status == 'final')
                    <a href="{{route('formulir')}}" class="btn btn-success">Edit Formulir</a>
                    @endif
                    @if($formulir->status == "final")
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <p>{{$formulir->data_rencana_sekolah->extra_peminatan}}</p>
                            </div>
                        </div>
                    </div>
