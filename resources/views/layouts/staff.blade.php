               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{route('staff.pembayaran.index')}}" class="nav-link {{Request::is('staff/pembayaran') ? 'active' : ''}}">
                                <i class="nav-icon fas fa-fw fa-money-bill"></i>
                                <p>
                                    Pembayaran
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="{{route('staff.siswa.kelulusan')}}" class="nav-link {{Request::is('staff/siswa/kelulusan') ? 'active' : ''}}">
                                <i class="nav-icon fas fa-fw fa-handshake"></i>
                                <p>
                                    Kelulusan
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="{{route('staff.operator.index')}}" class="nav-link {{Request::is('staff/operator/*') ? 'active' : ''}}">
