...
<script>
    ...
    $('input[type=file],input[name="berkas[no_seri_shun]"],input[name="berkas[no_seri_ijazah]"],input[name="berkas[no_peserta_un]"],[name="diri[cita_cita]"],[name="pendidikan[NSM]"],[name^="wali"],[name="berkas[no_pkh]"],[name="berkas[no_kip]"],[name="berkas[no_kks]"],[name="pendidikan[prestasi]"],[name="ayah[no_handphone]"],[name="ibu[no_handphone]"]').removeAttr('required')
