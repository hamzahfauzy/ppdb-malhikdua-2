...
<div class="form-group">
    <label for="">NSM SEKOLAH ASAL (Jika sekolah asal Madrasah) </label>
    <input type="number" name="pendidikan[NSM]" class="form-control">
</div>
<div class="form-group">
...
<div class="form-group">
    <label for="">Prestasi Saat di Sekolah Asal</label>
    <input type="text" name="pendidikan[prestasi]" class="form-control">
</div>
<div class="form-group">
