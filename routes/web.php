...
Route::get('sheet-test',function(){
    $client = new \Google\Client();
    $client->setAuthConfig('storage/credentials.json');
    $client->addScope(\Google\Service\Sheets::SPREADSHEETS);

    $service = new \Google\Service\Sheets($client);
    $spreadsheetId = '1xUz-01WZe6mand08L8kP9wmWYWr6qsgbrRAG0YhL0Bw';
    $range = 'Sheet1!A:C'; 
...
Route::middleware(['auth:staff'])->prefix('staff')->name('staff.')->group(function(){
    ...
    Route::resource('operator', App\Http\Controllers\Staff\OperatorController::class);
